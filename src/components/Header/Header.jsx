        ...
        <header className="mx-auto p-4 bg-darkHeader text-white bg-opacity-60 fixed w-full z-10">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    <button className="self-center px-8 py-3 rounded hover:text-yellow-500" onClick={()=>{
                        navigate('/login')
                    }}>Sign in</button>
                    <button className="self-center px-8 py-3 font-semibold rounded bg-yellow-400 text-gray-900 hover:text-white" onClick={()=>{
